    ...
    <div className="space-y-6">
      <section className="glass-card p-6">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h3 className="font-heading text-xl text-forest-300">🚗 Transporte Laboral</h3>
            <p className="text-xs text-carbon-500 mt-0.5">Ida y vuelta diaria — {opciones.constantes.dias_laborales} días/año</p>
          </div>
        ...
        {state.transporteLaboral.length === 0 ? (
          <p className="text-carbon-500 text-sm text-center py-6 border border-dashed border-carbon-700 rounded-lg">Sin transporte laboral registrado.</p>
        ) : (
          <div className="space-y-3">
            {state.transporteLaboral.map((item, i) => (
              <div key={i} className="glass-card-light p-3 flex flex-wrap items-end gap-3">
                <div className="flex-1 min-w-[140px]">
                  <label className="block text-[0.65rem] text-carbon-500 mb-1 uppercase">Vehículo</label>
                ...
                <div className="w-24">
                  <label className="block text-[0.65rem] text-carbon-500 mb-1 uppercase">Km ida</label>
                ...
                <div className="w-24">
                  <label className="block text-[0.65rem] text-carbon-500 mb-1 uppercase">Km vuelta</label>
      ...
      <section className="glass-card p-6">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h3 className="font-heading text-xl text-forest-300">✈️ Transporte Esporádico</h3>
            <p className="text-xs text-carbon-500 mt-0.5">Viajes puntuales</p>
          </div>
        ...
        {state.transporteEsporadico.length === 0 ? (
          <p className="text-carbon-500 text-sm text-center py-6 border border-dashed border-carbon-700 rounded-lg">Sin viajes esporádicos.</p>
        ) : (
          <div className="space-y-3">
            {state.transporteEsporadico.map((item, i) => (
              <div key={i} className="glass-card-light p-3 flex flex-wrap items-end gap-3">
                ...
                <div className="w-28">
                  <label className="block text-[0.65rem] text-carbon-500 mb-1 uppercase">Km totales</label>

    ...
    <div className="space-y-6">
      ...
      <section className="liquid-glass p-6">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h3 className="font-heading text-xl text-aether-800">🔥 Calefacción</h3>
            <p className="text-xs text-surface-400 mt-0.5">Temporada de invierno — {opciones.constantes.dias_invierno} días</p>
          </div>
      ...
      <section className="liquid-glass p-6">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h3 className="font-heading text-xl text-aether-800">❄️ Refrigeración</h3>
            <p className="text-xs text-surface-400 mt-0.5">Temporada de verano — {opciones.constantes.dias_verano} días</p>
          </div>
